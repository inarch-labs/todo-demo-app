...
import { OPEN_DOCKED_PARAM } from '@inarch/sdk/launcher'
 ...
 */
export function AppChrome({ branch, launcherSlot, children }: { branch: string; launcherSlot?: React.ReactNode; children: React.ReactNode }) {
